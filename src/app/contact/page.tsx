    ...
    return (
        <main className="w-full min-h-screen bg-gray-50">
            ...
            <section className="max-w-5xl mx-auto mt-10 mb-12 bg-gradient-to-br from-[#f3f6f9] to-[#fff6e6] rounded-2xl border border-slate-200 shadow-sm p-8 flex flex-col md:flex-row items-center gap-10">
                <div className="flex-1 flex flex-col justify-center">
                    ...
                    <p className="text-lg md:text-xl text-gray-600 mb-4">
                        Reach out to us for any inquiries, feedback, or partnership opportunities. We value your input and will respond as soon as possible.
                    </p>
                    <ul className="text-base md:text-lg text-gray-700 space-y-2">
                        <li><span className="font-semibold">Email:</span> contact@jwmj.org</li>
                        <li><span className="font-semibold">Phone:</span> +92 300 7654321</li>
                        <li><span className="font-semibold">Office:</span> 123 JWMJ Street, Karachi, Pakistan</li>
                    </ul>
                </div>
            ...
            <section className="max-w-3xl mx-auto bg-white rounded-2xl shadow-md border border-[#038DCD]/10 p-8 mb-16">
                <h2 className="text-[#038DCD] font-bold text-2xl mb-6 text-center">Send Us a Message</h2>
                <form className="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea className="w-full border border-gray-300 rounded-lg px-4 py-2 min-h-[120px] focus:outline-none focus:ring-2 focus:ring-[#038DCD]" placeholder="Type your message here..." required />
                    </div>
