...
export default function AboutPage() {
  return (
    <div className="bg-white mb-10 mx-10 justify-items-center">
      {/* Hero Section */}
      <section className="max-w-7xl p-16 grid md:grid-cols-2 gap-8 items-center bg-jwmj rounded-2xl">
        <div>
          ...
          <a
            href="#about"
            className="mt-6 inline-block text-sky-600 font-semibold text-lg"
          >
            Read more →
          </a>
        </div>
