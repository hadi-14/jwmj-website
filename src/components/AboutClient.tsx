        ...
        <div className="bg-white mb-10 mx-10 justify-items-center">
            ...
            <section id="aims" className="max-w-7xl px-4 py-16 place-items-center ">
                ...
                <div className="text-center w-full flex flex-row flex-wrap gap-6 justify-center">
                    <div className="p-6 rounded-2xl border border-gray-400 bg-jwmj flex items-center justify-centerw-64 md:w-72">
                    ...
                    <div className="p-6 rounded-2xl border border-gray-400 bg-jwmj flex items-center justify-center w-64 md:w-72">
                        <p className="text-sky-600 text-lg">
            ...
            {/* Vision */}
            <section id="vision" className="max-w-7xl p-8 rounded-2xl border-gray-400 border bg-jwmj">
